  ...
  <div class="martial-hall-view">
    ...
    <div class="mh-content">
      ...
      <div class="current-martial" v-if="currentMartial">
        <div class="cm-label text-gray">—— 今日传授 ——</div>
        <div class="martial-card">
          ...
          <div class="mc-actions">
            <button class="btn btn-red" @click="learn">修习此招</button>
            <button class="btn btn-ghost" @click="refresh">换一招（消耗1回合）</button>
          </div>
        </div>
      </div>
      <div v-else class="empty-tip">
        今日武馆无人传授武功……
        <button class="btn btn-ghost btn-sm" @click="refresh">去问问</button>
      </div>
...
.mc-name { font-size: 18px; font-weight: 900; color: var(--white); }
...
.ki-name { flex: 1; font-size: 13px; color: var(--white); }
